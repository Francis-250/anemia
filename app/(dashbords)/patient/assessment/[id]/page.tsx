        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg border p-4">
            ...
            <p className="text-xs text-muted-foreground">
              {assessment.fastScore} of 4 primary risk categories
            </p>
          </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="rounded-xl border overflow-hidden bg-card">
            ...
            <div className="grid gap-px bg-border sm:grid-cols-3">
              ...
              <div className="bg-background p-4">
                <p className="text-xs text-muted-foreground">Doctor review</p>
                <p className="mt-1 text-xl font-semibold">
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50/50 p-4">
            <p className="text-xs text-amber-800 leading-relaxed font-medium">
              Medical Disclaimer: Your information indicates a {assessment.riskLevel} risk of anemia. This is not a medical diagnosis. Please seek professional healthcare assessment and appropriate laboratory testing (such as Hemoglobin measurement).
            </p>
          </div>
        </div>
      </div>
