        ...
        <div className="space-y-4">
          {latestHighRisk && (
            <div className="rounded-lg border border-red-200 bg-red-50 p-4">
              ...
              <p className="text-xs text-red-600 leading-relaxed">
                Your {formatDate(latestHighRisk.createdAt)} assessment indicated a high risk of anemia. This is not a medical diagnosis. Please seek professional healthcare evaluation and laboratory blood testing.
              </p>
              <Link
          ...
          <div className="rounded-lg border p-4">
            ...
            <div className="space-y-3">
              {[
                { l: "N", title: "Nutrition", body: "Low iron intake or deficient diet" },
                { l: "S", title: "Symptoms", body: "Fatigue, weakness, dizziness, paleness" },
                { l: "B", title: "Blood Loss", body: "Heavy menstruation or blood loss history" },
                { l: "M", title: "Medical History", body: "Past anemia, chronic illness, pregnancy" },
              ].map(({ l, title, body }) => (
