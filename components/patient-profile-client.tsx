          ...
          <div className="rounded-lg border p-5">
            ...
            {editingMedical ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { key: "smokingStatus", label: "Low Iron Intake" },
                  { key: "diabetic", label: "Heavy Menstruation" },
                  { key: "hypertension", label: "Blood Loss History" },
                  { key: "heartDisease", label: "Chronic Disease" },
                ].map(({ key, label }) => (
                  <div
                    key={key}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                <RiskFlag label="Low Iron Intake" active={medical.smokingStatus} />
                <RiskFlag label="Heavy Menstruation" active={medical.diabetic} />
                <RiskFlag label="Blood Loss History" active={medical.hypertension} />
                <RiskFlag label="Chronic Disease" active={medical.heartDisease} />
              </div>
            )}
          </div>
